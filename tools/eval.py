...
parser.add_argument('--device', type=str, default='cuda',
                help='cpu or cuda')
parser.add_argument('--KD_file', type=str, default='',
                help='the file in KD_dataset, please end with .json')
parser.add_argument('--inference_mode', type=str, default='SAIC',
                help='SAIC/NAIC for choose inference mode under UIC')
