...
def parse_opt():
    ...
    parser.add_argument('--init_from', type=str, default=None,
                    help='PBIC init from AIC')

    # Model settings
    parser.add_argument('--train_mode', type=str, default="AIC",
                    help="AIC(Autoregressive), NNAIC(Naive Non-Autoregressive), NAIC(Non-Autogressive), \
                        SAIC(Semi-Autoregressive), UIC(Unified). Only useful for Transformer Model")
    parser.add_argument('--preprocess_mode', type=str, default="phrase",
                    help='phrase, word. Used for test data flow in model')
    parser.add_argument('--norm_mode', type=str, default='copy',
                    help='compress, copy, complex')
    parser.add_argument('--decoder_input_mode', type=str, default='add',
                    help='add, single, gate')                
    parser.add_argument('--N_len', type=int, default=0,
                    help='interge greater equal than 0, represent the layer num of length predictor')
    parser.add_argument('--self_dis', action='store_true', help='')
    parser.add_argument('--rl_kl', action='store_true', help='')
    ...
    parser.add_argument('--max_boxes', type=int, default=100,
                    help='max boxes for each pictures')
    ...
    # glancing training settings
    parser.add_argument('--glancing_token', type=bool, default=False,
                    help='whether or not to use glancing training with token level.')
    parser.add_argument('--unmasked_rate_decay_start', type=int, default=2,
                    help='which epoch start to drop unmasked token rate.')
    parser.add_argument('--unmasked_rate_decay_every', type=int, default=2,
                    help='how many epochs drop unmasked token rate once.')
    parser.add_argument('--unmasked_rate_decay_rate', type=float, default=0.1,
                    help='the rate will be dropped once.')
    parser.add_argument('--unmasked_rate_start', type=float, default=0.5,
                    help='initial unmasked rate.')
    parser.add_argument('--unmasked_rate_end', type=float, default=0.1,
                    help='final unmasked rate.')
